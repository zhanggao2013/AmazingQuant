...
bar.add("服装", ["衬衫", "羊毛衫", "雪纺衫", "裤子", "高跟鞋", "袜子"], [5, 20, 36, 10, 75, 90], tooltip_tragger="axis")
bar.add("服装0", ["衬衫", "羊毛衫", "雪纺衫", "裤子", "高跟鞋", "袜子"], [7, 2, 35, 17, 25, 60], symbol_size=0, line_opacity=0,tooltip_tragger="axis")
