...
def main():
    ...
    # 注册前置机地址，测试通过
    api.registerFront("tcp://218.202.237.33:10002")
    ...
    # req_auth = {}
    # req_auth['UserID'] = '112770'
    # req_auth['BrokerID'] = '9999'
    # req_auth['AuthCode'] = 132
    # reqid = reqid + 1  # 请求数必须保持唯一性
    #
    # a = api.reqAuthenticate(req_auth, reqid)
    # print(a)
    i = 0
    reqid = reqid + 1  # 请求数必须保持唯一性
    ...
    # reqid = reqid + 1  # 请求数必须保持唯一性
    # api.reqUserLogout(loginReq, reqid)
    ## 查询合约, 测试通过
    # reqid = reqid + 1
