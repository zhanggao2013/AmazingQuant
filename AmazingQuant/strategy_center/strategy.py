...
from AmazingQuant.constant import RunMode, Period, RightsAdjustment, SlippageType
...
class StrategyBase(metaclass=ABCMeta):
    def __init__(self):
        ...
        # 回测滑点设置
        def set_slippage(self, stock_type="stock", slippage_type=SlippageType.Slippage_Price.value, value=0):
            Environment.slippage_dict[stock_type] = {"slippage_type": slippage_type, "value": value}

        # 回测手续费和印花税
        def set_commission(self, stock_type="stock", tax=0, open_commission=0, close_commission=0,
