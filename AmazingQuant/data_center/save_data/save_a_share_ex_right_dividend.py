...
from AmazingQuant.data_center.database_field.field_a_share_ex_right_dividend import AExRightDividend
...
class SaveAExRightDividend(object):
    ...
    def save_a_ex_right_dividend(self):
        ...
        with MongoConnect(database):
            ...
            for index, row in self.data_df.iterrows():
                ...
                doc_list.append(doc)
                if len(doc_list) > 999:
                    AExRightDividend.objects.insert(doc_list)
                    doc_list = []
            else:
                AExRightDividend.objects.insert(doc_list)
...
if __name__ == '__main__':
    ...
    save_cash_flow_obj = SaveAExRightDividend(data_path, field_path)
    save_cash_flow_obj.save_a_ex_right_dividend()
